    ...
    return GlassCard(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        Wrap(spacing: 10, runSpacing: 10, children: [
          ...
          Field('Target account', width: 170, child: ZDropdown<String>(value: _target, items: const [('zedge_1', 'zedge_1'), ('zedge_2', 'zedge_2'), ('zedge_3', 'zedge_3'), ('all_accounts', 'all_accounts')], onChanged: (v) => setState(() => _target = v))),
        ]),
        const SizedBox(height: 10),
        Row(children: [
